...
;(function(){
    ...
    ************************************/
    ...
    jMoment.loadPersian = function (args) {
      ...
      , { months: ('فروردین_اردیبهشت_خرداد_تیر_امرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند').split('_')
        , monthsShort: ('فروردین_اردیبهشت_خرداد_تیر_امرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند').split('_')
        , weekdays:
          {
